...
public abstract class EntityFireballBase extends Entity
{
    ...
    public EntityFireballBase(World worldIn)
    {
        super(worldIn);
    ...
    public EntityFireballBase(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ)
    {
        super(worldIn);
    ...
    public EntityFireballBase(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ)
    {
        super(worldIn);
